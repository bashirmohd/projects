...
"""
Simulate the Dproute channel selection  environment.
...
filepath = pkg_resources.resource_filename('gym_dproute', path)
config = cfg_load.load(filepath)
logging.config.dictConfig(config['LOGGING'])


class DprouteEnv(gym.Env):
    """
    Define Dproute environment.
    ...
    def __init__(self, max_ticks=300):
        ...
        logging.info("DprouteEnv - Version {}".format(self.__version__))
