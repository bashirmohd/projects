...
class MininetBackEnd(object):
    ...
    def reset_links(self):
        ...
        self.active_link = 0 # internet2 by default
    ...
    def take_measurements(self):
        ...
        ## we measure  internet2 link only, MPLS(EXOGENI) link => full BW 
        ...
        # always measure internet2 link available bw
    ...
    def switch_link(self, action):
        ...
        ## action is 0 => link is internet2
        ## action 1 => MPLS(EXOGENI) 
