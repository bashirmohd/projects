...
"""
Simulate the DeepRoute RL dymanic Network Link  selection  environment.
...
class SdwanEnv(gym.Env):
    ...
    def take_action(self, action):
        ...
        # else Stop if max runs over
        elif self.runs == self.MAX_RUNS:
            logging.info ('Max runs over, ending episode')
    ...
    def get_reward(self):
        ...
        # otherwise, reward for surviving this 'run'
        reward = 1
